...
spark = SparkSession.builder.appName("example_etl") \
    ...
    .config("spark.sql.catalog.spark_catalog.glue.id", "572512847063") \
    .config("spark.sql.catalog.spark_catalog.io-impl", "org.apache.iceberg.aws.s3.S3FileIO") \
    .config("spark.sql.catalog.spark_catalog.warehouse", "s3://iova-iceberg-warehouse/") \
    .config("spark.sql.catalog.spark_catalog_b", "org.apache.iceberg.spark.SparkCatalog") \
    .config("spark.sql.catalog.spark_catalog_b.catalog-impl", "org.apache.iceberg.aws.glue.GlueCatalog") \
    .config("spark.sql.catalog.spark_catalog_b.glue.lakeformation-enabled", "true") \
    .config("spark.sql.catalog.spark_catalog_b.glue.id", "769026163231") \
